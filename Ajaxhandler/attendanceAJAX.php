...
require_once $path."/Attendance-App/database/sessionDetails.php";
require_once $path."/Attendance-App/database/facultyDetails.php";
require_once $path."/Attendance-App/database/courseRegistrationDetails.php";
require_once $path."/Attendance-App/database/attendanceDetails.php";
